<template>
  <div class="event-content">
    ...
    <div class="event-tab" @click="changeCollapse(2, $event)">未完成
...
export default {
  ...
  methods: {
    moveToDone (id) {
      this.$store.dispatch('done_event', id)
    },
    moveToDo (id) {
      this.$store.dispatch('todo_event', id)
    },
    moveCancel (id) {
      this.$store.dispatch('cancel_event', id)
    },
